...
codex mcp remove dual-graph >nul 2>&1
codex mcp add --transport http dual-graph "http://localhost:%MCP_PORT%/mcp" >nul 2>&1 || codex mcp add dual-graph --url "http://localhost:%MCP_PORT%/mcp"
